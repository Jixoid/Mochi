...
namespace mochi::sys
{
  ...
  struct DisplaySystem: noncopy {
    public:
      explicit DisplaySystem(rhi::Device &device, sys::SceneSystem &smng, std::string_view title, int width, int height);
      ~DisplaySystem();
      
      rhi::Device &m_device;
      sys::SceneSystem &m_smng;
    ...
    private:
      ...
      static fun framebuffer_resize_callback(GLFWwindow* win, int width, int height) -> void;
