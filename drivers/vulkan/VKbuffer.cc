...
namespace mochi::rhi::vulkan
{
  ...
  VK_Buffer::VK_Buffer(rhi::Device &device, VmaAllocator vma_allocator, VkBuffer buffer, VmaAllocation allocation, void* mapped, u64 size)
    : m_device(device)
  ...
  fun VK_Buffer::address() const -> u64 {
    ...
    return static_cast<VK_Device&>(m_device).get().getBufferAddress(addr_info);
  }
