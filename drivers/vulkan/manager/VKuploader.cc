...
#include "drivers/vulkan/manager/VKuploader.hh"
...
{
  extern "C" fun MochiRHI_MakeUploader(rhi::Device &dmng) -> Uploader* {
    return new VK_Uploader(dmng);
  }


  VK_Uploader::VK_Uploader(rhi::Device &dmng)
    : rhi::Uploader(dmng)
  {}

  fun VK_Uploader::copyMemoryToImage(rhi::TransferTime time, void* src, rhi::Image2* dst) -> void {
  ...
  fun VK_Uploader::copyMemoryToBuffer(rhi::TransferTime time, void* src, rhi::Buffer* dst) -> void {
